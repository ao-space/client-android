...
/**
 * Author:      Zhu Fuyu
 * Description: app/盒子系统检查升级返回
 * History:     2021/11/8
 */
public class VersionCheckResponseBody extends BaseResponseBody implements Serializable {
    ...
    public static class Results implements Serializable, EulixKeep {
        @SerializedName("latestAppPkg")
        public LatestAppPkg latestAppPkg;
        @SerializedName("latestBoxPkg")
        public LatestAppPkg latestBoxPkg;
        @SerializedName("newVersionExist")
        public Boolean newVersionExist;
        @SerializedName("isBoxNeedUpdate")
        public Boolean isBoxNeedUpdate;
        @SerializedName("isAppNeedUpdate")
        public Boolean isAppNeedUpdate;

        
        public static class LatestAppPkg implements Serializable,EulixKeep {
        ...
        public String toString() {
            return "Results{" +
                    ...
                    ", isBoxNeedUpdate=" + isBoxNeedUpdate +
    ...
    @Override
    public String toString() {
        return "VersionCheckResponseBody{" +
                "results=" + results +
                ", codeInt=" + codeInt +
                ", code='" + code + '\'' +
                ", message='" + message + '\'' +
