...
public class ClipImageView extends ImageView implements
    ...
    private void updateBorder() {
        ...
        if (mDrawCircleFlag == false) { // 如果是圆形,宽高比例是1:1
    ...
    public void drawRectangleOrCircle(Canvas canvas) {
        ...
        if (mDrawCircleFlag) { // 画圆
            ...
            RectF rectBorderLeft = new RectF(mClipBorder.left, mClipBorder.top, getResources().getDimensionPixelOffset(R.dimen.dp_2), mClipBorder.bottom);
            temp.drawRect(rectBorderLeft, borderPaint);
            RectF rectBorderTop = new RectF(mClipBorder.left, mClipBorder.top - getResources().getDimensionPixelOffset(R.dimen.dp_2), mClipBorder.right, mClipBorder.top);
            temp.drawRect(rectBorderTop, borderPaint);
            RectF rectBorderRight = new RectF(mClipBorder.right - getResources().getDimensionPixelOffset(R.dimen.dp_2), mClipBorder.top, mClipBorder.right, mClipBorder.bottom);
            temp.drawRect(rectBorderRight, borderPaint);
            RectF rectBorderBottom = new RectF(mClipBorder.left, mClipBorder.bottom, mClipBorder.right, mClipBorder.bottom + getResources().getDimensionPixelOffset(R.dimen.dp_2));
