...
package xyz.eulix.space.view.dragselect
...
import xyz.eulix.space.view.dragselect.Mode.PATH
import xyz.eulix.space.view.dragselect.Mode.RANGE
...
class DragSelectTouchListener private constructor(
    ...
    var hotspotHeight: Int = context.dimen(R.dimen.dp_100)
    var hotspotOffsetTop: Int = -context.dimen(R.dimen.dp_50)
    var hotspotOffsetBottom: Int = -context.dimen(R.dimen.dp_50)
