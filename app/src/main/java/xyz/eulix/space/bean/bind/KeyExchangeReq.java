...
public class KeyExchangeReq implements EulixKeep {
    ...
    public String getClientPreSecret() {
        return clientPreSecret;
    }

    public void setClientPreSecret(String clientPreSecret) {
        this.clientPreSecret = clientPreSecret;
    }
    ...
    public void setEncBtid(String encBtid) {
        this.encBtid = encBtid;
    }

    @Override
    public String toString() {
        return "KeyExchangeReq{" +
                "clientPreSecret='" + clientPreSecret + '\'' +
                ", encBtid='" + encBtid + '\'' +
                '}';
    }
}
