...
public class ErrorUtil {
    ...
    public void writerLog(Throwable ex, boolean isReaderFile) {
        writerLog(ex, isReaderFile, false);
    }
...
//            if (isShowErrorDialog) {
                processThrowable(ex, isReaderFile, isShowErrorDialog);
//            }
     ...
     *
     */
    private void processThrowable(final Throwable ex, final boolean isReaderFile, final boolean isShowDialog) {
