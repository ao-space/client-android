...
public class SSEventManage extends AEventManage  implements ITimerListener
{
     ...
     *
     *(non-Javadoc)
     * @see com.wxiwei.office.system.beans.AEventManage#onLongPress(android.view.MotionEvent)
     *
     */
     ...
     *
     *(non-Javadoc)
     * @see com.wxiwei.office.system.beans.AEventManage#onScroll(android.view.MotionEvent, android.view.MotionEvent, float, float)
     *
     */
